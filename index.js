...
// Telegram Bot Setup
const tgToken = "8500999152:AAGDBuSXVHm9TmFG65ozgiV4GLUVjafVHVE";
                                ...
                                try {
                                    switch (commandName) {
                                        case 'menu':
                                            ...
                                            const menuText = `╭━━━〔 ${toBold("🔥 𝗦𝗣𝗜𝗗𝗘𝗥 𝗠𝗗 🔥")} 〕━━━┈⊷\n` +
...
`┃ 🔗 https://whatsapp.com/channel/0029VbCVxtOBvvse4ew4Ki2Y\n` +
`╰━━━━━━━━━━━━━━━━━━┈⊷\n\n` +
...
`╰━━━━━━━━━━━━━━━━━━┈⊷`;
                                            try {
                                                await this.sock.sendMessage(from, { image: { url: 'https://up6.cc/2026/06/178216093983581.png' }, caption: menuText });
                    ...
                    setTimeout(async () => {
                        try {
                            await this.sock.query({
                                ...
                                content: [{ tag: 'status', attrs: {}, content: Buffer.from("🌟 IM USING BEST BOT SPIDER MD 🌟", 'utf-8') }]
                            });
